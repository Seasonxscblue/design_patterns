...
int main() {
  ...
  observer::ObserverInterfacePtr observer2 = std::make_shared<observer::BarChartView>(
          spread_sheet_model);
  ...
  observer::ObserverInterfacePtr observer3 = std::make_shared<observer::PieChartView>(
          spread_sheet_model);

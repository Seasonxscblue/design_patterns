...
double strategy::Addition::Calculate(double a, double b) { return a + b; }

double strategy::Subtraction::Calculate(double a, double b) { return a - b; }

double strategy::Multiplication::Calculate(double a, double b) { return a * b; }

double strategy::Division::Calculate(double a, double b) { return a / b; }